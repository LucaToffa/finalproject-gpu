...
void transposeCSRToCSC(const thrust::host_vector<int>& h_values, const thrust::host_vector<int>& h_col_indices,
...
int main() {
    // Example CSR matrix
    thrust::host_vector<int> h_values = {10, 20, 30, 40, 50, 60, 70, 80};
    thrust::host_vector<int> h_col_indices = {0, 2, 1, 0, 1, 2, 0, 1};
    thrust::host_vector<int> h_row_ptr = {0, 2, 4, 7, 8};
    int num_rows = 4;
    int num_cols = 3;
